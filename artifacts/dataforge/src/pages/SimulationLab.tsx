    ...
    <div className="animate-in fade-in duration-500 max-w-7xl mx-auto">
      ...
      <div className="bg-[#161B22] border border-[#30363D] rounded-lg p-5 mb-4 flex justify-between">
        <div>
          ...
          <div className="flex gap-2">
            {c.models.concat(['SMOTE']).map(m => (
              <span key={m} className="text-[11px] font-mono uppercase px-2 py-0.5 rounded bg-[#21262D] text-[#8B949E] border border-[#30363D]">
                {m}
              </span>
            ))}
          </div>
        ...
        <div className="text-right flex flex-col items-end">
          ...
          <div className="text-sm text-[#F59E0B] flex items-center gap-1">
            <span>⏰</span> Due in 3 days
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4 mb-4">
        ...
        <div className="w-48 shrink-0 flex flex-col gap-4">
          ...
          <div className="bg-[#161B22] border border-[#30363D] rounded-lg p-3 flex flex-col gap-2">
            ...
            {c.models.map(m => (
               <span key={m} className="text-[11px] font-mono uppercase px-2 py-1 rounded bg-[#1C1038] text-[#C4B5FD] border border-[#4C1D95] text-center">
                 {m}
               </span>
            ))}
          </div>
          ...
          <AnimatePresence>
            {isComplete && (
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="mt-2 bg-[#1C1038] border border-[#4C1D95] p-4 rounded-lg flex flex-col items-center justify-center text-center shadow-[0_0_20px_rgba(124,58,237,0.15)]"
              >
                ...
                <div className="text-4xl text-[#C4B5FD] font-mono font-bold mb-1">
                  88<span className="text-sm text-[#22C55E] font-sans ml-1">/100 · PASSED ✓</span>
                </div>
                <div className="flex gap-2 mt-3">
                  <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-[#052E16] text-[#22C55E] border border-[#14532D]">+290 XP</span>
